...
const LedgerStatementInternal: React.FC = () => {
...
export default function LedgerStatement() { return <Suspense fallback={<div>Loading...</div>}><LedgerStatementInternal /></Suspense>; }

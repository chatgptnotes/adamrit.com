...
const BillAgingStatementInternal: React.FC = () => {
    ...
    <div className="container mx-auto p-4 space-y-4 print:p-0">
      ...
      <div className="flex items-center justify-between print:hidden">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={() => router.push('/expected-payment-date-report')}>
...
export default function BillAgingStatement() { return <Suspense fallback={<div>Loading...</div>}><BillAgingStatementInternal /></Suspense>; }

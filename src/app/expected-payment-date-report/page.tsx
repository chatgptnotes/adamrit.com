...
const ExpectedPaymentDateReportInternal: React.FC = () => {
    ...
    <div className="container mx-auto p-4 space-y-4 print:p-0">
      ...
      <div className="flex items-center justify-between print:hidden">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => router.push('/bill-aging-statement')}>
...
export default function ExpectedPaymentDateReport() { return <Suspense fallback={<div>Loading...</div>}><ExpectedPaymentDateReportInternal /></Suspense>; }

...
const PatientOverview = () => {
  ...
  const activeTab = searchParams.get('tab') || 'call-today';

  const setActiveTab = (tab: string) => {
    const newParams = new URLSearchParams(searchParams.toString()); newParams.set('tab', tab); router.replace(`${pathname}?${newParams.toString()}`);
  };

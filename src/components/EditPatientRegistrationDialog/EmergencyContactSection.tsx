...
export const EmergencyContactSection: React.FC<EmergencyContactSectionProps> = ({
  ...
  return (
    <div className="bg-red-50 p-4 rounded-lg">
      <h3 className="text-lg font-semibold text-red-700 mb-4">Emergency Contact</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="2nd Emergency Contact Name"
        ...
        <div className="space-y-2">
          <Label htmlFor="secondEmergencyContactMobile" className="text-sm font-medium">
            2nd Emergency Contact Mobile
          </Label>
          <Input
            id="secondEmergencyContactMobile"
            placeholder="2nd Emergency Contact Mobile"
